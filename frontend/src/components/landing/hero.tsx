  ...
  return (
    <section className="relative z-10 overflow-hidden">
      <div
        ...
        style={{
          maskImage:
            "radial-gradient(ellipse 46% 56% at 50% 50%, transparent 0%, transparent 24%, black 72%)",
          WebkitMaskImage:
            "radial-gradient(ellipse 46% 56% at 50% 50%, transparent 0%, transparent 24%, black 72%)",
        }}
      >
      ...
      <div className="relative z-10 mx-auto flex max-w-[900px] flex-col items-center px-12 pb-[100px] pt-[110px] text-center">
        <div
